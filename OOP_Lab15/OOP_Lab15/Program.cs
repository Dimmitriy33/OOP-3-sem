...
namespace OOP_Lab15
{
    class Program
    {
        ...
        {
            //1
            using (StreamWriter stream = new StreamWriter(@"D:\учеба\ООП\lab15\Processes.txt", false))
            {
            ...
            //2
            using (StreamWriter stream = new StreamWriter(@"D:\учеба\ООП\lab15\Domain.txt", false))
            {
            ...
            //3
            AppDomain MyDomain = AppDomain.CreateDomain("SDLDomain");
